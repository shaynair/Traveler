...
/**
 * A class that represents a train or subway ride.
 */
public class Railroad extends SingleTravel {
  /**
   ...
   *          the given capacity
   */
  public Railroad(TravelType type, String id, Date start, Date end, String origin,
